...
For example, we can use this **<a target="_blank" href="/files/quick-start/schema.yaml" download="schema.yaml">schema file</a>** and **<a target="_blank" href="/files/quick-start/plan.yaml" download="plan.yaml">plan file</a>** to generate data, structured as illustrated below
